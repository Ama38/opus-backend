...
<h2>3. Оплата</h2>
<p>Оплата за выполненную работу производится клиентом мастеру напрямую, наличными, после подтверждения выполнения заказа.
Платформа не является стороной этого расчёта и не удерживает комиссию с заказа.</p>
