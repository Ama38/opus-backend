...
# How often the master leaderboard ranking is recomputed (TZ §7.2: weekly).
MASTERGO_LEADERBOARD_SNAPSHOT_INTERVAL_HOURS = float(
    os.getenv("MASTERGO_LEADERBOARD_SNAPSHOT_INTERVAL_HOURS", "168")
)
MASTERGO_MAX_ONLINE_HOURS = int(os.getenv("MASTERGO_MAX_ONLINE_HOURS", "8"))
MASTERGO_SUPPORT_INACTIVITY_HOURS = int(
    os.getenv("MASTERGO_SUPPORT_INACTIVITY_HOURS", "3")
)
